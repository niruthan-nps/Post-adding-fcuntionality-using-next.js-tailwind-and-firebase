       ...
       <div className="flex justify-between max-w-6xl mx-auto">
        ...
        <div className="lg:flex-col p-3 h-screen border-1 hidden lg:flex w-[24rem]">
          <div className="sticky top-0 bg-white py-2">
            <input type="text" placeholder="Search" className="bg-gray100 border border-gray-200 rounded-3xl text-sm w-full px-4 py-2"/>
          </div>
          <News />
        </div>
       </div>
...
//         <div className="flex justify-between max-w-6xl mx-auto">
//           {/* Sidebar */}
//           <div className="hidden sm:inline border-r min-h-screen">
//             <Sidebar />
//           </div>
//           {/* Main content */}
...
//           </div>
//           {/* News Section */}
//           <div className="lg:flex-col p-3 min-h-screen border hidden lg:flex w-[24rem]">
//             <div className="sticky top-0 bg-white py-2">
//               <input
//                 type="text"
//                 placeholder="Search"
